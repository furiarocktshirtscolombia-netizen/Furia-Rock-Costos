...
export const GARMENTS: Garment[] = [
  ...
  },
  {
    ...
    printAreaFront: { x: 120, y: 120, width: 260, height: 320, maxWidthCm: 40, maxHeightCm: 50, collarOffsetCm: 9 },
    printAreaBack: { x: 120, y: 110, width: 260, height: 320, maxWidthCm: 40, maxHeightCm: 50, collarOffsetCm: 7 },
  ...
  },
  {
    ...
    printAreaFront: { x: 140, y: 100, width: 180, height: 220, maxWidthCm: 22, maxHeightCm: 30, collarOffsetCm: 6 },
    printAreaBack: { x: 140, y: 95, width: 180, height: 220, maxWidthCm: 22, maxHeightCm: 30, collarOffsetCm: 5 },
  ...
  },
  {
    ...
    printAreaFront: { x: 130, y: 150, width: 240, height: 260, maxWidthCm: 32, maxHeightCm: 36, collarOffsetCm: 11 },
    printAreaBack: { x: 120, y: 110, width: 260, height: 320, maxWidthCm: 40, maxHeightCm: 50, collarOffsetCm: 8 },
  ...
  },
  {
    ...
    printAreaFront: { x: 150, y: 140, width: 180, height: 220, maxWidthCm: 20, maxHeightCm: 25, collarOffsetCm: 9 },
    printAreaBack: { x: 130, y: 100, width: 240, height: 280, maxWidthCm: 35, maxHeightCm: 40, collarOffsetCm: 7 },
  ...
  },
  {
    ...
    printAreaFront: { x: 130, y: 140, width: 240, height: 260, maxWidthCm: 35, maxHeightCm: 40, collarOffsetCm: 9 },
    printAreaBack: { x: 120, y: 110, width: 260, height: 320, maxWidthCm: 40, maxHeightCm: 50, collarOffsetCm: 7 },
  ...
  },
  {
    ...
    printAreaFront: { x: 140, y: 130, width: 200, height: 260, maxWidthCm: 25, maxHeightCm: 35, collarOffsetCm: 7 },
    printAreaBack: { x: 140, y: 120, width: 200, height: 280, maxWidthCm: 25, maxHeightCm: 38, collarOffsetCm: 6 },
