...
import { GARMENTS, getGarmentById } from '../data/products';
import { ViewSide, CartItem } from '../types';
import { AUTOSAVE_INTERVAL_MS, LOCAL_DRAFT_KEY } from '../config';
import { saveDesignToBackend, sendProductionOrder } from '../utils/gasApi';

  export default function DesignerApp() {
  const [garmentId, setGarmentId] = useState(GARMENTS[0].id);
const garment = getGarmentById(garmentId) || GARMENTS[0];
